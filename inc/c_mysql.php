...
class mysql {
  ...
  function __construct($db=array()) {
    ...
    $this->info = array_merge($default,$db);
    $this->con=mysql_connect($this->info['host'],$this->info['user'],$this->info['pass'],true) or die ('Error connecting to MySQL');
    mysql_select_db($this->info['db'],$this->con) or die('Database '.$this->info['db'].' does not exist!');
  }
  function getInfo(){
    return($this->info);
  }
